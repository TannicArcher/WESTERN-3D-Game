...
#define Q3_VERSION PRODUCT_NAME " " PRODUCT_VERSION
...
#else
  // Tequila: WESTERN3D defines update
  ...
  #define PRODUCT_NAME				"WESTERN 3D"
  #define PRODUCT_SHORTNAME			"WESTERN 3D"
  #define PRODUCT_URL				"soon"
  #define BASEGAME					"WESTERN 3D"
  ...
  #define SDK_BASEGAME				"WESTERN3D"
  #define CLIENT_WINDOW_TITLE		PRODUCT_NAME
  #define CLIENT_WINDOW_MIN_TITLE 	"WS3D"
  #define GAMENAME_FOR_MASTER		"WESTERN3D"
  #define HEARTBEAT_FOR_MASTER		GAMENAME_FOR_MASTER
  #define FLATLINE_FOR_MASTER		GAMENAME_FOR_MASTER "WESTERN 3D"
  #define HOMEPATH_NAME_UNIX		".WESTERN3D"
  ...
  // Tequila comment: activate WESTERN3D MOD only features
  #define WESTERN3D_MOD
  #endif
#endif
...
// bit field limits
#define	MAX_STATS				16
#ifndef WESTERN3D_MOD
#define	MAX_PERSISTANT			16
#define	MAX_POWERUPS			16
#define	MAX_WEAPONS				16
#else
// Must be changed for WESTERN3D MOD
...
#ifdef WESTERN3D_MOD	// Only used by SG mod
	int			oldbuttons;
#endif
