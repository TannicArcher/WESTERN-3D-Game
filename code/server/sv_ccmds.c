...
//			SV_SendServerCommand(NULL, "print \"%s" S_COLOR_WHITE "'s game was recorded as " S_COLOR_GREEN "https://discord.gg/hUqegqKmUx" S_COLOR_YELLOW "%s\n\"", cl->name, demoname);
		} else {
