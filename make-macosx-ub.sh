#!/bin/bash
APPBUNDLE="WESTERN 3D.app"
BINARY=western3d.ub
DEDBIN=western3d_dedicated.ub
PKGINFO=APPLSG
ICNS=misc/western3d.icns
DESTDIR=build/release-darwin-ub
BASEDIR=western3d

BIN_OBJ="
	build/release-darwin-ppc/western3d.ppc
	build/release-darwin-i386/western3d.i386
"
BIN_DEDOBJ="
	build/release-darwin-ppc/western3d_dedicated.ppc
	build/release-darwin-i386/western3d_dedicated.i386
"

cd `dirname $0`
if [ ! -f Makefile ]; then
	echo "This script must be run from the western3d build directory"
	exit 1
fi
...
cp $ICNS "$DESTDIR/$APPBUNDLE/Contents/Resources/western3d.icns" || exit 1;
...
echo "
	...
	<dict>
		...
		<string>WESTERN 3D $SG_VERSION</string>
		<key>CFBundleIconFile</key>
		<string>western3d.icns</string>
		<key>CFBundleIdentifier</key>
		<string>net.smokin-guns.www</string>
		<key>CFBundleInfoDictionaryVersion</key>
		<string>6.0</string>
		<key>CFBundleName</key>
		<string>western3d</string>
...
lipo build/release-darwin-ppc/western3d.ppc build/release-darwin-i386/western3d.i386 -create -output "$DESTDIR/$APPBUNDLE/Contents/MacOS/$BINARY"
lipo build/release-darwin-ppc/western3d_dedicated.ppc build/release-darwin-i386/western3d_dedicated.i386 -create -output "$DESTDIR/$APPBUNDLE/Contents/MacOS/$DEDBIN"
